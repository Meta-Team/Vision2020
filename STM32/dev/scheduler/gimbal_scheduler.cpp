...
void GimbalSKD::SKDThread::main() {
    ...
    while (!shouldTerminate()) {
        ...
        angle[0] = ahrs_angle.x;
        angle[1] = ahrs_angle.y;
        float velocity[2] = {
        ...
        if (mode == ABS_ANGLE_MODE) {
            ...
            target_velocity[YAW] = target_angle[YAW];
...
//            }
            ...
            target_velocity[PITCH] = target_angle[PITCH];
...
float GimbalSKD::get_ahrs_angle(GimbalBase::motor_id_t motor) {
    return angle[motor];
}
